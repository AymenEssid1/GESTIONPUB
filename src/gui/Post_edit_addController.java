...
public class Post_edit_addController implements Initializable {
    ...
    private void ajouterPost(ActionEvent event) throws IOException {
        ...
        sp.ajouter(new post(Long.parseLong(tfuseridpost.getText()),taposttitle.getText(),tapostcontent.getText())); //la méthode getText() retourne toujours une chaine de caractère 
